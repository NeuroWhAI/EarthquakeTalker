...
namespace EarthquakeTalker
{
    class Program
    {
        ...
        static void Work()
        {
            ...
            { DangerValue = 0.03, DangerWaveTime = 0.01, MinDangerWaveTime = 0.005, IsAccel = false });
            seismographList.Add(new WinstonSeismograph(winstonIp, winstonPort, "00", "ENZ", "AM", "R3E8F", 3.87e+05 * 9.80665 / 100, "포항")
            { DangerValue = 0.1, DangerWaveTime = 0.6, MinDangerWaveTime = 0.2, IsAccel = true, Endian = true });
